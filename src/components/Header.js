...
const Header = () => {
	...
	return (
		<div className='py-6 w-screen px-8 absolute z-10 bg-gredient-to-b from-black flex justify-between'>
			...
			{ user && <div className='flex'>
				...
				<button className='btn btn-primary bg-red-900 text-white rounded-md cursor-pointer p-2'
